...
Junior data analyst and historian of the Middle East, based in Berlin.

As a historian, I learned to question sources and read them in their original
languages. Numbers and code won me over because they can be checked. I bring
...
| [dune-api-pipeline](https://github.com/Amirhouschang/dune-api-pipeline) | Python ETL from API to Power BI star schema |
| [global-defense-sector-analysis](https://github.com/Amirhouschang/global-defense-sector-analysis) | Defense stocks and geopolitical events |
| [multi-asset-dca-portfolio-analysis](https://github.com/Amirhouschang/multi-asset-dca-portfolio-analysis) | Portfolio risk and dimensional modelling |
